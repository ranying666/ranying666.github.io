...
(function() {
  ...
  _.bindAll = function(obj) {
    ...
    if (length <= 0="" 1)="" throw="" new="" error('bindall="" must="" be="" passed="" function="" names');="" for="" (i="1;" i="" <="" length;="" i++)="" {="" key="arguments[i];" obj[key]="_.bind(obj[key]," obj);="" }="" return="" obj;="" };="" memoize="" an="" expensive="" by="" storing="" its="" results.="" _.memoize="function(func," hasher)="" var="" cache="memoize.cache;" address="" +="" (hasher="" ?="" hasher.apply(this,="" arguments)="" :="" key);="" if="" (!_.has(cache,="" address))="" cache[address]="func.apply(this," arguments);="" cache[address];="" memoize.cache="{};" memoize;="" delays="" a="" the="" given="" number="" of="" milliseconds,="" and="" then="" calls="" it="" with="" arguments="" supplied.="" _.delay="function(func," wait)="" args="slice.call(arguments," 2);="" settimeout(function(){="" func.apply(null,="" args);="" },="" wait);="" defers="" function,="" scheduling="" to="" run="" after="" current="" call="" stack="" has="" cleared.="" _.defer="_.partial(_.delay," _,="" 1);="" returns="" that,="" when="" invoked,="" will="" only="" triggered="" at="" most="" once="" during="" window="" time.="" normally,="" throttled="" as="" much="" can,="" without="" ever="" going="" more="" than="" per="" `wait`="" duration;="" but="" you'd="" like="" disable="" execution="" on="" leading="" edge,="" pass="" `{leading:="" false}`.="" trailing="" ditto.="" _.throttle="function(func," wait,="" options)="" context,="" args,="" result;="" timeout="null;" previous="0;" (!options)="" options="{};" later="function()" =="=" false="" _.now();="" result="func.apply(context," (!timeout)="" context="args" null;="" function()="" now="_.now();" (!previous="" &&="" options.leading="==" false)="" remaining="wait" -="" (now="" previous);="" (remaining="" ||=""> wait) {
        if (timeout) {
  ...
  _.before = function(times, func) {
    ...
    return function() {
      ...
      if (times <= 0="" 1="" 8="" 9="" 11="" 1)="" func="null;" return="" memo;="" };="" returns="" a="" function="" that="" will="" be="" executed="" at="" most="" one="" time,="" no="" matter="" how="" often="" you="" call="" it.="" useful="" for="" lazy="" initialization.="" _.once="_.partial(_.before," 2);="" object="" functions="" ----------------="" keys="" in="" ie="" <="" won't="" iterated="" by="" `for="" key="" ...`="" and="" thus="" missed.="" var="" hasenumbug="!{toString:" null}.propertyisenumerable('tostring');="" nonenumerableprops="['valueOf'," 'isprototypeof',="" 'tostring',="" 'propertyisenumerable',="" 'hasownproperty',="" 'tolocalestring'];="" collectnonenumprops(obj,="" keys)="" {="" nonenumidx="nonEnumerableProps.length;" constructor="obj.constructor;" proto="(_.isFunction(constructor)" &&="" constructor.prototype)="" ||="" objproto;="" is="" special="" case.="" prop="constructor" ;="" if="" (_.has(obj,="" prop)="" !_.contains(keys,="" prop))="" keys.push(prop);="" while="" (nonenumidx--)="" (prop="" obj="" obj[prop]="" !="=" proto[prop]="" }="" retrieve="" the="" names="" of="" an="" object's="" own="" properties.="" delegates="" to="" **ecmascript="" 5**'s="" native="" `object.keys`="" _.keys="function(obj)" (!_.isobject(obj))="" [];="" (nativekeys)="" nativekeys(obj);="" (var="" obj)="" key))="" keys.push(key);="" ahem,="" 9.="" (hasenumbug)="" keys);="" keys;="" all="" property="" object.="" _.allkeys="function(obj)" values="" _.values="function(obj)" length="keys.length;" i="0;" length;="" i++)="" values[i]="obj[keys[i]];" values;="" results="" applying="" iteratee="" each="" element="" contrast="" _.map="" it="" _.mapobject="function(obj," iteratee,="" context)="" context);="" currentkey;="" index="0;" index++)="" currentkey="keys[index];" results[currentkey]="iteratee(obj[currentKey]," currentkey,="" obj);="" results;="" convert="" into="" list="" `[key,="" value]`="" pairs.="" _.pairs="function(obj)" pairs="Array(length);" pairs[i]="[keys[i]," obj[keys[i]]];="" pairs;="" invert="" must="" serializable.="" _.invert="function(obj)" result="{};" result[obj[keys[i]]]="keys[i];" result;="" sorted="" available="" on="" aliased="" as="" `methods`="" _.functions="_.methods" =="" function(obj)="" (_.isfunction(obj[key]))="" names.push(key);="" names.sort();="" extend="" given="" with="" properties="" passed-in="" object(s).="" _.extend="createAssigner(_.allKeys);" assigns="" object(s)="" (https:="" developer.mozilla.org="" docs="" web="" javascript="" reference="" global_objects="" assign)="" _.extendown="_.assign" createassigner(_.keys);="" first="" passes="" predicate="" test="" _.findkey="function(obj," predicate,="" key;="" (predicate(obj[key],="" key,="" obj))="" copy="" only="" containing="" whitelisted="" _.pick="function(object," oiteratee,="" (obj="=" null)="" (_.isfunction(oiteratee))="" else="" false,="" 1);="" obj;="" value="obj[key];" (iteratee(value,="" result[key]="value;" without="" blacklisted="" _.omit="function(obj," (_.isfunction(iteratee))="" 1),="" string);="" key)="" key);="" _.pick(obj,="" fill="" default _.defaults="createAssigner(_.allKeys," true);="" creates="" inherits="" from="" prototype="" additional="" are="" provided="" then="" they="" added="" created="" _.create="function(prototype," props)="" (props)="" _.extendown(result,="" props);="" create="" (shallow-cloned)="" duplicate="" _.clone="function(obj)" _.isarray(obj)="" ?="" obj.slice()="" :="" _.extend({},="" invokes="" interceptor="" obj,="" obj.="" primary="" purpose="" this="" method="" "tap="" into"="" chain,="" order="" perform="" operations="" intermediate="" within="" chain.="" _.tap="function(obj," interceptor)="" interceptor(obj);="" whether="" has="" set="" `key:value`="" _.ismatch="function(object," attrs)="" (object="=" !length;="" (attrs[key]="" obj[key]="" !(key="" false;="" true;="" internal="" recursive="" comparison="" `isequal`.="" eq="function(a," b,="" astack,="" bstack)="" identical="" objects="" equal.="" `0="==" -0`,="" but="" aren't="" identical.="" see="" [harmony="" `egal`="" proposal](http:="" wiki.ecmascript.org="" doku.php?id="harmony:egal)." (a="==" b)="" b;="" strict="" necessary="" because="" `null="=" undefined`.="" null="" b="=" unwrap="" any="" wrapped="" objects.="" instanceof="" _)="" (b="" compare="" `[[class]]`="" names.="" classname="toString.call(a);" (classname="" tostring.call(b))="" switch="" (classname)="" strings,="" numbers,="" regular="" expressions,="" dates,="" booleans="" compared="" value.="" case="" '[object="" regexp]':="" regexps="" coerced="" strings="" (note:="" ''="" +="" '="" i')="" string]':="" primitives="" their="" corresponding="" wrappers="" equivalent;="" thus,="" `"5"`="" equivalent="" `new="" string("5")`.="" number]':="" `nan`s="" equivalent,="" non-reflexive.="" object(nan)="" nan="" (+a="" +a)="" +b="" +b;="" performed="" other="" numeric="" values.="" +a="==" date]':="" boolean]':="" coerce="" dates="" primitive="" millisecond="" representations.="" note="" invalid="" representations="" `nan`="" not="" equivalent.="" arearrays="className" array]';="" (!arearrays)="" (typeof="" typeof="" )="" different="" constructors="" `object`s="" or="" `array`s="" frames="" are.="" actor="a.constructor," bctor="b.constructor;" (actor="" !(_.isfunction(actor)="" _.isfunction(bctor)="" bctor)="" ('constructor'="" 'constructor'="" b))="" assume="" equality="" cyclic="" structures.="" algorithm="" detecting="" structures="" adapted="" es="" 5.1="" section="" 15.12.3,="" abstract="" operation="" `jo`.="" initializing="" stack="" traversed="" it's="" done="" here="" since="" we="" need="" them="" arrays="" comparison.="" astack="aStack" bstack="bStack" (length--)="" linear="" search.="" performance="" inversely="" proportional="" number="" unique="" nested="" (astack[length]="==" a)="" bstack[length]="==" add="" astack.push(a);="" bstack.push(b);="" recursively="" arrays.="" (arearrays)="" array="" lengths="" determine="" deep="" necessary.="" (length="" b.length)="" contents,="" ignoring="" non-numeric="" (!eq(a[length],="" b[length],="" bstack))="" ensure="" both="" contain="" same="" before="" comparing="" equality.="" (_.keys(b).length="" length)="" member="" (!(_.has(b,="" eq(a[key],="" b[key],="" bstack)))="" remove="" astack.pop();="" bstack.pop();="" check="" two="" _.isequal="function(a," eq(a,="" b);="" array,="" string,="" empty?="" "empty"="" enumerable="" own-properties.="" _.isempty="function(obj)" (isarraylike(obj)="" (_.isarray(obj)="" _.isstring(obj)="" _.isarguments(obj)))="" obj.length="==" 0;="" _.keys(obj).length="==" dom="" element?="" _.iselement="function(obj)" !!(obj="" obj.nodetype="==" array?="" ecma5's="" array.isarray="" _.isarray="nativeIsArray" tostring.call(obj)="==" variable="" object?="" _.isobject="function(obj)" type="typeof" 'function'="" 'object'="" !!obj;="" some="" istype="" methods:="" isarguments,="" isfunction,="" isstring,="" isnumber,="" isdate,="" isregexp,="" iserror.="" _.each(['arguments',="" 'function',="" 'string',="" 'number',="" 'date',="" 'regexp',="" 'error'],="" function(name)="" _['is'="" name]="function(obj)" name="" ']';="" });="" define="" fallback="" version="" browsers="" (ahem,="" 9),="" where="" there="" isn't="" inspectable="" "arguments"="" type.="" (!_.isarguments(arguments))="" _.isarguments="function(obj)" _.has(obj,="" 'callee');="" optimize="" `isfunction`="" appropriate.="" work="" around="" bugs="" old="" v8,="" (#1621),="" safari="" (#1929).="" .="" int8array="" _.isfunction="function(obj)" finite="" number?="" _.isfinite="function(obj)" isfinite(obj)="" !isnan(parsefloat(obj));="" `nan`?="" (nan="" which="" does="" equal="" itself).="" _.isnan="function(obj)" _.isnumber(obj)="" +obj;="" boolean?="" _.isboolean="function(obj)" true="" false="" boolean]';="" null?="" _.isnull="function(obj)" null;="" undefined?="" _.isundefined="function(obj)" void="" shortcut="" checking="" directly="" itself="" (in="" words,="" prototype).="" _.has="function(obj," hasownproperty.call(obj,="" utility="" -----------------="" run="" underscore.js="" *noconflict*="" mode,="" returning="" `_`="" its="" previous="" owner.="" underscore="" _.noconflict="function()" root._="previousUnderscore;" this;="" keep="" identity="" iteratees.="" _.identity="function(value)" value;="" predicate-generating="" functions.="" outside="" underscore.="" _.constant="function(value)" function()="" _.noop="function(){};" _.property="property;" generates="" property.="" _.propertyof="function(obj)" function(){}="" function(key)="" obj[key];="" _.matcher="_.matches" function(attrs)="" attrs="_.extendOwn({}," attrs);="" _.ismatch(obj,="" **n**="" times.="" _.times="function(n," accum="Array(Math.max(0," n));="" context,="" n;="" accum[i]="iteratee(i);" accum;="" random="" integer="" between="" min="" max="" (inclusive).="" _.random="function(min," max)="" (max="=" math.floor(math.random()="" *="" -="" 1));="" (possibly="" faster)="" way="" get="" current="" timestamp="" integer.="" _.now="Date.now" new="" date().gettime();="" html="" entities="" escaping.="" escapemap="{" '&':="" '&amp;',="" '<':="" '&lt;',="">': '&gt;',
    '"': '&quot;',
    "'": '&#x27;',
    '`': '&#x60;'
  };
 ...
 *
 * <figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br></pre></td><td class="code"><pre><span class="line">* request.post(<span class="string">'/upload'</span>)</span><br><span class="line">*   .attach(<span class="string">'content'</span>, <span class="keyword">new</span> Blob([<span class="string">'&lt;a id="a"&gt;&lt;b id="b"&gt;hey!&lt;/b&gt;&lt;/a&gt;'</span>], &#123; <span class="attr">type</span>: <span class="string">"text/html"</span>&#125;))</span><br><span class="line">*   .end(callback);</span><br><span class="line">*</span><br></pre></td></tr></table></figure>
  ...
  _.extend(AV.File.prototype, /** @lends AV.File.prototype */{
    ...
    **/
    ...
    thumbnailURL: function thumbnailURL(width, height, quality, scaleToFit, fmt) {
      ...
      if (!width || !height || width <= 0="" ||="" height="" <="0)" {="" throw="" new="" error('invalid="" width="" or="" value.');="" }="" quality="quality" 100;="" scaletofit="!scaleToFit" ?="" true="" :="" scaletofit;="" if="" (quality=""> 100) {
...
AV.init = function init(options) {
  if (!isObject(options)) {
    return AV.init({
      appId: options,
      appKey: arguments.length <= 1="" ?="" undefined="" :="" arguments[1],="" masterkey:="" arguments.length="" <="2" arguments[2],="" region:="" arguments[3]="" });="" }="" var="" appid="options.appId," appkey="options.appKey," masterkey="options.masterKey," hookkey="options.hookKey," _options$region="options.region," region="_options$region" =="=" 'cn'="" _options$region,="" serverurls="options.serverURLs," disablecurrentuser="options.disableCurrentUser," production="options.production," realtime="options.realtime;" if="" (av.applicationid)="" throw="" new="" error('sdk="" is="" already="" initialized.');="" ("browser"="" &&="" masterkey)="" console.warn('masterkey="" not="" supposed="" to="" be="" used="" in="" browser.');="" av._config.applicationid="appId;" av._config.applicationkey="appKey;" av._config.masterkey="masterKey;" (false)="" av._config.hookkey="hookKey" ||="" process.env.leancloud_app_hook_key;="" (typeof="" !="=" 'undefined')="" av._config.production="production;" av._config.disablecurrentuser="disableCurrentUser;" av._approuter="new" approuter(av);="" disableapprouter="_disableAppRouter" typeof="" 'undefined'="" 'cn';="" av._setserverurls(extend({},="" getdefaultserverurls(appid,="" region),="" av._config.serverurls,="" serverurls),="" disableapprouter);="" (realtime)="" {="" av._config.realtime="realtime;" else="" (av._sharedconfig.livequeryrealtime)="" av._sharedconfig.livequeryrealtime({="" appid:="" appid,="" };="" we're="" running="" node.js,="" allow="" using="" the="" master="" key.="" av.cloud="AV.Cloud" {};="" **="" *="" switches="" leancloud="" sdk="" key="" grants="" priveleged="" access="" data="" and="" can="" bypass="" acls="" other="" restrictions="" that="" are="" applied="" client="" sdks.="" <p=""><strong><em>Available in Cloud Code and Node.js only.</em></strong>
   * <p></p>
   */
...
module.exports = function (AV) {
   ...
   *
   * Visit <a href="https://leancloud.cn/docs/app_search_guide.html" target="_blank" rel="noopener">App Searching Guide</a>
   * for more details.
   * @class
   * @since 0.5.1
   * @example
...
/**
  ...
  <figure class="highlight javascript"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br><span class="line">8</span><br><span class="line">9</span><br><span class="line">10</span><br><span class="line">11</span><br><span class="line">12</span><br><span class="line">13</span><br><span class="line">14</span><br><span class="line">15</span><br><span class="line">16</span><br></pre></td><td class="code"><pre><span class="line"><span class="keyword">let</span> promise1 = <span class="keyword">new</span> <span class="built_in">Promise</span>(<span class="function"><span class="keyword">function</span>(<span class="params">resolve, reject</span>)</span>&#123;</span><br><span class="line">  setTimeout(<span class="function"><span class="keyword">function</span>(<span class="params"></span>)</span>&#123;</span><br><span class="line">    resolve(<span class="string">'promise 1'</span>);</span><br><span class="line">  &#125;, <span class="number">200</span>);</span><br><span class="line">&#125;);</span><br><span class="line"></span><br><span class="line"><span class="keyword">let</span> promise2 = <span class="keyword">new</span> <span class="built_in">Promise</span>(<span class="function"><span class="keyword">function</span>(<span class="params">resolve, reject</span>)</span>&#123;</span><br><span class="line">  setTimeout(<span class="function"><span class="keyword">function</span>(<span class="params"></span>)</span>&#123;</span><br><span class="line">    resolve(<span class="string">'promise 2'</span>);</span><br><span class="line">  &#125;, <span class="number">100</span>);</span><br><span class="line">&#125;);</span><br><span class="line"></span><br><span class="line"><span class="built_in">Promise</span>.race([promise1, promise2]).then(<span class="function"><span class="keyword">function</span>(<span class="params">result</span>)</span>&#123;</span><br><span class="line">  <span class="comment">// result === 'promise 2' because it was resolved before promise1</span></span><br><span class="line">  <span class="comment">// was resolved.</span></span><br><span class="line">&#125;);</span><br></pre></td></tr></table></figure>
...
RequestBase.prototype.retry = function retry(count){
  ...
  if (count <= 0)="" count="0;" this._maxretries="count;" this._retries="0;" return="" this;="" };="" **="" *="" retry="" request="" @return="" {request}="" for="" chaining="" @api="" private="" requestbase.prototype._retry="function()" {="" this.cleartimeout();="" node="" if="" (this.req)="" this.req="null;" }="" this._aborted="false;" this.timedout="false;" this._end();="" promise="" support="" @param="" {function}="" resolve="" [reject]="" requestbase.prototype.then="function" then(resolve,="" reject)="" (!this._fullfilledpromise)="" var="" self="this;" (this._endcalled)="" console.warn("warning:="" superagent="" was="" sent="" twice,="" because="" both="" .end()="" and="" .then()="" were="" called.="" never="" call="" you="" use="" promises");="" this._fullfilledpromise="new" promise(function(innerresolve,="" innerreject){="" self.end(function(err,="" res){="" (err)="" innerreject(err);="" else="" innerresolve(res);="" });="" this._fullfilledpromise.then(resolve,="" reject);="" requestbase.prototype.catch="function(cb)" this.then(undefined,="" cb);="" allow="" extension="" requestbase.prototype.use="function" use(fn)="" fn(this);="" requestbase.prototype.ok="function(cb)" ('function'="" !="=" typeof="" cb)="" throw="" error("callback="" required");="" this._okcallback="cb;" requestbase.prototype._isresponseok="function(res)" (!res)="" false;="" (this._okcallback)="" this._okcallback(res);="" res.status="">= 200 && res.status < 300;
};
 ...
 *
 * <figure class="highlight js"><table><tr><td class="gutter"><pre><span class="line">1</span><br><span class="line">2</span><br><span class="line">3</span><br><span class="line">4</span><br><span class="line">5</span><br><span class="line">6</span><br><span class="line">7</span><br><span class="line">8</span><br></pre></td><td class="code"><pre><span class="line">* request.post(<span class="string">'/upload'</span>)</span><br><span class="line">*   .field(<span class="string">'foo'</span>, <span class="string">'bar'</span>)</span><br><span class="line">*   .end(callback);</span><br><span class="line">*</span><br><span class="line">* request.post(<span class="string">'/upload'</span>)</span><br><span class="line">*   .field(&#123; <span class="attr">foo</span>: <span class="string">'bar'</span>, <span class="attr">baz</span>: <span class="string">'qux'</span> &#125;)</span><br><span class="line">*   .end(callback);</span><br><span class="line">*</span><br></pre></td></tr></table></figure>
...
//# sourceMappingURL=av.js.map</=></http:></feross@feross.org></=></av.user></av.user></boolean></av.object></av.object></xzhuang@avoscloud.com></av.object[]></pre></=></av.geopoint></=></string></date></av.captcha></string></string></seenobjects></%-([\s\s]+?)%></%=([\s\s]+?)%></%([\s\s]+?)%></=></=></=>